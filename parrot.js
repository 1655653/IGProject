function drawParrot(){
    //*******************/
    //*********BODY */
    var materialpapp = new THREE.MeshPhongMaterial( { color: 0xff0000});
    var radius = 0.4;
    ...
    parrot = new THREE.Mesh( geometryBody, materialpapp );
    ...
    // console.log(parrot.children[0].position.y);
    ...
    //*****WINGDX*****
    Textwingdx = new THREE.TextureLoader().load('images/wing.PNG');
    Textwingdx.offset.x = -0.27;
    ...
    var materialWingpapp = new THREE.MeshPhongMaterial( { color: 0xffffff, map: Textwingdx, transparent:true});

    var wingDx2 = new THREE.Mesh( geometryWing, new THREE.MeshPhongMaterial( { color: 0xff0000} ));
    wingDx = new THREE.Mesh( geometryWing, materialWingpapp );
    ...
    //*****WINGSX*****
    Textwingsx = new THREE.TextureLoader().load('images/wing.PNG');
    Textwingsx.offset.x = 0.24;

    var wingSx2 = new THREE.Mesh( geometryWing, new THREE.MeshPhongMaterial( { color: 0xff0000} ));
    wingSx = new THREE.Mesh( geometryWing, new THREE.MeshPhongMaterial( { color: 0xffffff, map: Textwingsx, transparent:true}));
    ...
    parrot.add(legDx);
        ...
        legDx.add(FingDx1);
            //*****Fingerdx11*****
            var minifingradius = fingradius/1.2;
